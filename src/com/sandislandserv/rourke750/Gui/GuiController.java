...
public class GuiController {
	...
	@FXML private TextField mainPlayer;
	@FXML private TextField altToAdd;
	@FXML private Button addAlt;
	@FXML private Label addErrorMessage;

	private ObservableList<Person> data = FXCollections.observableArrayList();
    public GuiController() {
    	db = BetterAssociations.getDataBaseManager();
    }
    ...
    public void addAlt(){
		...
		String main = mainPlayer.getText();
		String alt = altToAdd.getText();
    	if (main.equals("") || alt.equals("")){
    		addErrorMessage.setVisible(true);
    		return;
    	}
    	db.associatePlayer(main, alt);
